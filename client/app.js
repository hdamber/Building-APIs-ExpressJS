            ...
            $('#chirps-container').append(
                `<div class="card" style="width: 22rem; height: 200px">
                    <div class="card-body">
                        ...
                        <img class="edit-icon" src="./img/edit.png" alt="" data-toggle="modal" data-target="#modal${chirp[0]}"></button>
                    <img class="delete-icon" src="./img/delete.png" alt="" onclick=deleteChirp(${chirp[0]})></button>
                    </div>
                </div>
